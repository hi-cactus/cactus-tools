        ...
        .reduce((acc, operation, index, arr) => {
            ...
            if (index === arr.length - 1) {
                ...
                >((acc, [tag, target]) => {
                    ...
                    const hasAwaitedType = compareVersions(
                        typescriptVersion,
                        '4.5.0'
                    );
                    ...
                    const header = builder.header({
                        outputClient: options.client,
                        isRequestOptions:
                            options.override.requestOptions !== false,
                        isMutator,
